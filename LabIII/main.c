...
extent %d\n\n", &c, sizeof(c));
//Адреса указателей и размер выделяемой памяти printf("p1: pointer: start address %p \
extent %d\n", &p1, sizeof(p1)); printf("p2: pointer: start address %p \
extent %d\n", &p2, sizeof(p2)); printf("p3: pointer: start address %p \
extent %d\n\n", &p3, sizeof(p3));
